    ...
    Craft.SimpleFormsFieldLayoutDesigner = Craft.FieldLayoutDesigner.extend(
        {
            initField: function($field)
            {
                ...
                {
                    $('<li><a data-action="toggle-required">'+Craft.t('simple-forms', 'Make not required')+'</a></li>').appendTo($ul);
                }
                else
                {
                    $('<li><a data-action="toggle-required">'+Craft.t('simple-forms', 'Make required')+'</a></li>').appendTo($ul);
                }

                $('<li><a data-action="edit">'+Craft.t('simple-forms', 'Edit field')+'</a></li>').appendTo($ul);
                $('<li><a data-action="remove">'+Craft.t('simple-forms', 'Remove')+'</a></li>').appendTo($ul);
